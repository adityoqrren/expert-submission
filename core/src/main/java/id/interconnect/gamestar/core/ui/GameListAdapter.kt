...
import id.interconnect.gamestar.core.R
import id.interconnect.gamestar.core.databinding.ItemListBinding
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(data: Game) {
            with(binding) {
                ...
                itemTitle.text = data.name_original
                itemPlatform.text = data.parent_platforms
